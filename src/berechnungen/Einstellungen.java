...
public class Einstellungen {
    private int weltengeschwindigkeit;
    private int minengeschwindigkeit;
    private boolean belohnungenAktiv;
    private int[] produktionsraten = {10, 30, 35, 41, 47, 55, 64, 74, 86, 100, 117, 136, 158, 184, 214, 249, 289, 337, 391, 455, 530, 616, 717, 833, 969, 1127, 1311, 1525, 1774, 2063, 2400};
